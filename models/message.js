...
module.exports = Arrow.createModel('message', {
  fields: {
    ...
    to: { type: String, description: 'The phone number that received the message in E.164 format.' },
    ...
    body: { type: String, description: 'The text body of the message. Up to 1600 characters long.' },
